            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="POST"
                                action="{{ Auth::user()->role == 'admin' ? route('editpost-data', base64_encode($id)) : route('editpost-biodata', base64_encode($id)) }}"
                                ...
                                <div class="form-row mb-3">
                                    ...
                                    <div class="col-9">
                                        <input type="text" class="form-control" id="validationTooltip05"
                                            name="posisi" required value="{{ $data->posisi }}">
                                ...
                                <div class="form-row mb-3">
                                    ...
                                    <div class="col-9">
                                        <input type="text" class="form-control" id="validationTooltip05"
                                            name="no_ktp" required value="{{ $data->no_ktp }}">
                                        <div class="invalid-tooltip">
                                            Please Add the Data!
                                        </div>
                                    </div>
                                ...
                                <div class="form-row mb-3">
                                    ...
                                    <div class="col-3">
                                        <input type="text" class="form-control" id="validationTooltip05"
                                            name="tmp_lahir" required value="{{ $data->tmp_lahir }}">
                                        <div class="invalid-tooltip">
                                            Please Add the Data!
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-4">
                                        <input type="date" class="form-control" id="validationTooltip05"
                                            name="tgl_lahir" required value="{{ $data->tgl_lahir }}">
                                        <div class="invalid-tooltip">
                                            Please Add the Data!
                                        </div>
                                    </div>
